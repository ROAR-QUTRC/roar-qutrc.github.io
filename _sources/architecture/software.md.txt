...
Runs `software/scripts/clean.sh` to remove all generated/build directories.

#### `tools.scripts.cachix-push`

Push `default`, `simulation`, and `docs` packages and dev shells to Cachix, as well as some of the outputs of `tools.scripts`.
